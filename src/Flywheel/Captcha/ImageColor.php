...
class ImageColor {
    ...
    /**
     * Create a new ImageColor object.
     *
     ...
     * Examples:
     *
     *     $color = new \Flywheel\Captcha\ImageColor('#0080FF');
     *     $color = new \Flywheel\Captcha\ImageColor(0, 128, 255);
     *
        ...
        if (sizeof($args) == 0) {
            ...
            if (strlen($color) != 3 && strlen($color) != 6) {
                throw new \InvalidArgumentException(
                    'Invalid HTML color code passed to ImageColor'
                );
            }
            ...
            throw new \InvalidArgumentException(
                'ImageColor constructor expects 0, 1 or 3 arguments; ' . sizeof($args) . ' given'
            );
        }
    }
